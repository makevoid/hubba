(function(angular) {
  ...
  describe('SHA1', function() {
    ...
    it('SHA1 empty string', inject(['SHA1', function(SHA1) {
      var sha1ed = SHA1.SHA1('');
      expect(sha1ed).toEqual('da39a3ee5e6b4b0d3255bfef95601890afd80709');
    }]));

    it('SHA1 for \'Cantami o diva del pelide Achille l\'ira funesta\'', inject(['SHA1', function(SHA1) {
    ...
    it('SHA1 for \'Contami o diva del pelide Achille l\'ira funesta\'', inject(['SHA1', function(SHA1) {
    ...
    it('SHA1 for \'The quick brown fox jumps over the lazy dog\'', inject(['SHA1', function(SHA1) {
    ...
    it('SHA1 for \'The quick brown fox jumps over the lazy cog\'', inject(['SHA1', function(SHA1) {
